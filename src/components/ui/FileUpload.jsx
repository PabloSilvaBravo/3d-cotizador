...
export const FileUpload = ({ onFileSelect, onBack }) => {
    ...
    return (
        <div className="relative">
            ...
            {onBack && (
                <motion.button
                    onClick={onBack}
                    className="absolute -top-16 left-0 inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-slate-600 hover:text-brand-primary bg-white/60 hover:bg-white/80 backdrop-blur-sm rounded-xl border border-slate-200 hover:border-brand-primary transition-all duration-300 shadow-sm hover:shadow-md"
