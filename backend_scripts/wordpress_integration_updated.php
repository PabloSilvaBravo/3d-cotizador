...
'layer_height' => isset($cotizacion['layerHeight']) ? sanitize_text_field($cotizacion['layerHeight']) :
(isset($cotizacion['layer_height']) ? sanitize_text_field($cotizacion['layer_height']) : ''),
'dimensions' => isset($cotizacion['dimensions']) ? sanitize_text_field($cotizacion['dimensions']) : '', // string
"XxYxZ" en mm
